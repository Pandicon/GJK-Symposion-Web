...
pub fn kontakty() -> Html {
	...
	html! {
		...
		<main>
			<div class="opakujici_most"></div>
			<div class="icons">
				<a href="https://fb.me/SymposionGjk"><img src="../../images/FACEBOOK.png" width="80px" /></a>
				<a href="https://instagram.com/symposion_gjk"><img src="../../images/INSTAGRAM.png" width="80px" /></a>
				<a href="mailto:symposion@gjk.cz"><img src="../../images/MAIL.png" width="80px" /></a>
			</div>
			<div class="address">
				...
				<div class="school_wrapper">
					...
					<img src="../../images/most_icon.png" width="90px" />
